  ...
  return (
    <>
      <p className="mb-4 text-lg text-gray-700">
        ...
        the quotes that inspire, provoke, and resonate with them. We believe in
        the power of words and aim to create a space that celebrates meaningful
        thoughts, curated by the community.
      </p>
      <p className="mb-4 text-lg text-gray-700">
